...
btn1 = tk.Button(text="train your own model", width=20, height=2, font=myfont, bg='#2AFFB0', relief=tk.GROOVE)

#btn1_01 = tk.Button(text="your voice(10 mins at least)")
#btn1_02 = tk.Button(text="convert")

btn2 = tk.Button(text="get your cover(\"model required!!!\")", width=30, height=2, font=myfont, bg='#2AFFB0', relief=tk.GROOVE)
#btn2_01 = tk.Button(text="upload model")
#btn2_02 = tk.Button(text="upload songs")

btn3 = tk.Button(text="vocal seperation", width=20, height=2, font=myfont, bg='#2AFFB0', relief=tk.GROOVE)


btn1.place(x=85,y=130)
btn2.place(x=90,y=310)
btn3.place(x=90,y=490)
